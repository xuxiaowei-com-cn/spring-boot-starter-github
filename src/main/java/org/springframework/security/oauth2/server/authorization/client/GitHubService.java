...
public interface GitHubService {
	 ...
	 * 拦截处理此异常
	 */
	GitHubProperties.GitHub getGitHubByAppid(String appid) throws OAuth2AuthenticationException;
	 ...
	 * 拦截处理此异常
	 */
	GitHubTokenResponse getAccessTokenResponse(String appid, String code, String state, String binding,
